...
<center>
	<a href="scoreByIdNumber.php" class="btn btn-info" style="width:96%;font-weight:bold;font-size:21px;"><i class="fa fa-id-card-o" aria-hidden="true"></i> 按 身 份 证 号 查 询</a>
	<br><br>
